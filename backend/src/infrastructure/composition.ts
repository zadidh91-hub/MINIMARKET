...
import {
  ...
  PrismaSaleRegistrationWriter,
} from "../modules/sales/adapters/outbound/persistence/PrismaSaleRepository.js";
...
import { BoletaValidator } from "../modules/sales/domain/receipt/BoletaValidator.js";
import { FacturaValidator } from "../modules/sales/domain/receipt/FacturaValidator.js";
import { ReceiptValidationService } from "../modules/sales/application/services/ReceiptValidationService.js";
...
export function createContainer() {
  ...
  return {
    ...
    useCases: {
      ...
      listMovements: new ListInventoryMovementsUseCase(
        movements,
      ),

      registerMovement: new RegisterInventoryMovementUseCase(
        products,
        stockWriter,
      ),
